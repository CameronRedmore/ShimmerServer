 ...
 * @return {Object}
 */
function processHeader(headerBuffer) {
    const headers = {};
    ...
    headers["streamName"] = headerBuffer.toString("ascii", 8, 24);

    // Frame Counter (32 bits)
    headers["frameCounter"] = headerBuffer.readUInt32LE(24);
...
function processPacket(packet) {
    const header = processHeader(packet.slice(0, 28));
